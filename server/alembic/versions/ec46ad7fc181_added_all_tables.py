...
Revises: 
Create Date: 2022-04-28 14:04:42.176345
...
def upgrade():
    ...
    op.create_index(op.f("ix_release_date"), "movie", ["release_date"], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f("ix_release_date"), table_name="movie")
